...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "showNames": { zh: "显示用户和助手名称", en: "Show Names" },
  ...
  "userProfile": { zh: "用户资料", en: "Profile" },
  "userName": { zh: "用户名称", en: "Username" },
  "userAvatar": { zh: "头像", en: "Avatar" },
  "assistantAvatar": { zh: "助手头像", en: "Assistant Avatar" },
  "uploadAvatar": { zh: "上传头像", en: "Upload Avatar" },
  "resetAvatar": { zh: "重置", en: "Reset" },
  "showNamesLabel": { zh: "显示用户和助手名称", en: "Show User & Assistant Names" },
  ...
  "exportUser": { zh: "用户", en: "User" },
  "exportThinking": { zh: "思维过程", en: "Thinking" },
  "exportInput": { zh: "输入", en: "Input" },
  "exportOutput": { zh: "输出", en: "Output" },
  "setupTitle": { zh: "数据库初始化", en: "Database Setup" },
  "setupHint": { zh: "点击下方按钮复制 SQL，然后去 Supabase 的 SQL Editor 粘贴运行。", en: "Copy the SQL with the button below, then paste and run it in the Supabase SQL Editor." },
  "setupCopied": { zh: "✓ 已复制到剪贴板", en: "✓ Copied to clipboard" },
  "setupCopySql": { zh: "复制建表 SQL", en: "Copy setup SQL" },
  "setupOpenEditor": { zh: "打开 Supabase SQL Editor →", en: "Open Supabase SQL Editor →" },
  "charsUnit": { zh: "字符", en: "chars" },
  "voiceNeedApiKey": { zh: "请先填写 API Key", en: "Please enter the API key first" },
  "voiceNeedVoiceId": { zh: "请填写 Voice ID", en: "Please enter the Voice ID" },
  "elModelV3": { zh: "Eleven v3 (70+ 语言)", en: "Eleven v3 (70+ languages)" },
  "elModelMulti": { zh: "Multilingual v2 (29 语言)", en: "Multilingual v2 (29 languages)" },
  "elModelFlash": { zh: "Flash v2.5 (低延迟)", en: "Flash v2.5 (low latency)" },
  "elVoiceIdHint": { zh: "elevenlabs.io → Voices → 复制 Voice ID", en: "elevenlabs.io → Voices → copy the Voice ID" },
  ...
  "orTtsHint": { zh: "使用聊天配置的 OpenRouter Key，无需额外填写", en: "Uses your existing OpenRouter key — no extra setup" },
  "sttSection": { zh: "语音识别", en: "Speech Recognition" },
  "sttHint": { zh: "听写按钮与语音对话共用此识别模型（走 OpenRouter）", en: "Used by dictation and voice chat (via OpenRouter)" },
  "sttLanguage": { zh: "语言提示", en: "Language hint" },
  "sttLangAuto": { zh: "自动检测（支持中英混说）", en: "Auto detect (handles mixed languages)" },
  "sttFailed": { zh: "语音识别失败", en: "Transcription failed" },
  "dictating": { zh: "录音中，再点一次结束…", en: "Recording… tap again to stop" },
  "transcribingHint": { zh: "识别中…", en: "Transcribing…" },
  "voiceListening": { zh: "我在听", en: "Listening" },
  "voiceTranscribing": { zh: "识别中…", en: "Transcribing…" },
  "voiceThinking": { zh: "思考中…", en: "Thinking…" },
  "voiceTapToSkip": { zh: "点击圆球跳过播放", en: "Tap the orb to skip" },
  "voiceTapToFinish": { zh: "说完后停顿即自动发送，或点击圆球立即发送", en: "Pause when done to send, or tap the orb" },
  "voiceMicDenied": { zh: "无法访问麦克风，请检查浏览器权限", en: "Microphone access denied — check permissions" },
  "voiceMicUnsupported": { zh: "当前浏览器不支持录音", en: "Recording not supported in this browser" },
